        ...
        <nav className="navbar navbar-expand-lg navbar-dark navbar-custom" id="#mainNav">
            <div className="container-fluid">
                ...
                <ul className="custom-navbar-nav navbar-nav mr-auto">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link" to="/myDocument">My Documents</Link>
                    </li>
                    <li className="nav-btn">
                        <Link className="btn header-btn custom-btn-blue" to="/plan">Upgrade plan</Link>
                    </li>
                    <li className="nav-btn">
                        <Link to="/createAkiipbox" className="btn header-btn custom-btn-skyblue">Create a KiipBox</Link>
                    </li>
                    <li className="nav-btn">
                        <Link to="/referAfriend" className="btn header-btn custom-btn-white">Refer a friend</Link>
                    </li>
                </ul>
                <ul className="navbar-nav">
                    <li className="nav-item dropdown">
                    <Link className="nav-link dropdown-toggle" to="/" id="dropdown-1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
